...
const EmailPrecision = () => {
  ...
  return (
    ...
    >
      ...
      <div className="w-full px-6 sm:px-8 md:px-12 lg:px-16 xl:px-24 2xl:px-[9.031rem] py-8 lg:py-12">
        <div className="max-w-full lg:max-w-[1250px] mx-auto relative">
          ...
          <div className="w-full flex flex-col lg:flex-row lg:justify-between lg:items-center gap-[0.3188rem] md:gap-[0.425rem] lg:gap-[0.5313rem]">
            ...
            <div className="w-full lg:w-auto flex flex-col gap-[0.2125rem]">
              ...
              <div className="flex flex-col gap-[0.1063rem] min-w-0">
                ...
                {/* Line 1 */}
                <div className="flex flex-wrap items-center gap-[0.1593rem] min-w-0">
                  <span
                    data-animate-item
            ...
            {/* RIGHT SIDE */}
            <div className="w-full lg:flex-1 lg:max-w-[35.2553rem]">
              <p
                data-animate-item
                style={{ transitionDelay: "0.25s" }}
                className="home-description-emailprecision pt-4 text-[18px] text-[#546779] font-['Manrope'] text-left"
              >
