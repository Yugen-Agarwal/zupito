...
const HeroSection = () => {
  ...
  return (
    ...
    >
      {/* Container */}
      <div className="w-full mx-auto px-4 sm:px-6 md:px-8 lg:px-12 xl:px-24 2xl:px-[150px]">
        <div className="max-w-full lg:max-w-[1250px] mx-auto flex flex-col items-center">
          {/* Headline Section */}
              ...
              <div className="w-full max-w-full mb-[40px]">
                <div className="flex flex-col sm:flex-row items-center justify-center gap-4 sm:gap-[10px]">
                  ...
                  <input
                    ...
                    className="w-full sm:w-[420px] h-[60px] rounded-[58px] border border-[#C1DDDA] bg-white px-[34px] py-[24px] text-[#132436] placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-[#659DF8] transition-all font-['Manrope'] home-description"
                  />
