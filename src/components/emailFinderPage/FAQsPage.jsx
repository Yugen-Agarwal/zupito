...
const FAQsPage = () => {
  ...
  return (
    ...
    >
      ...
      <div className="w-full flex justify-center px-6! sm:px-8! md:px-12! lg:px-16! xl:px-24! 2xl:px-[150px]!">
          ...
          <div className="w-full">
            ...
            <div className="flex flex-col md:flex-row lg:flex-row lg:items-start lg:justify-between gap-6 lg:gap-[21px] mt-4! h-auto" style={{ alignItems: 'end' }}>
              ...
              <div className="flex-1 max-w-[568px] lg:max-w-none">
                <p data-animate-item style={{ transitionDelay: '0.08s' }} className="home-description text-[#546779] font-[Manrope]">
                ...
                >
                  ...
                  >
                    <div className="flex-1 pr-4!">
                      <h3 className="text-[20px] font-semibold text-[#132436] font-['Manrope'] capitalize">
                    ...
                    <button
                      data-hover="lift"
                      className={`shrink-0 w-[50px] h-[35px] sm:w-[55px] sm:h-[38px] md:w-[60px] md:h-[40px] rounded-[50px] flex items-center justify-center transition-all duration-300 cursor-pointer ${openIndex === index
                          ? 'bg-[#132436]'
                          : 'bg-[#F6F6F6]'
                        }`}
