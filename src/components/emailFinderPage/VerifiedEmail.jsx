...
const VerifiedEmail = () => {
  ...
  return (
    <section ref={sectionRef} data-animate="fade-up" className="w-full relative">
      ...
      <div className="w-full px-6 sm:px-8 md:px-12 lg:px-16 xl:px-24 2xl:px-[150px] ">
        <div className="max-w-full lg:max-w-[1250px] mx-auto">
          {/* Main content block */}
          <div className="w-full max-w-full lg:max-w-[1250px] mx-auto">
            ...
            <div className="flex flex-col gap-4 sm:gap-16 md:gap-4 lg:gap-4 ">
              ...
              <div className="w-full flex flex-col gap-[21px] items-center">
                {/* Heading Section */}
                <div className="w-full max-w-[1250px] flex flex-col gap-[21px]">
                  {/* Main Heading */}
                  <h2
                    data-animate-item
                    className="home-title text-[#132436] flex flex-col gap-5 text-center font-['Manrope']"
                  >
              ...
              <div>
                ...
                <div className="relative w-full max-w-full mx-auto -top-20 md:-top-28 lg:-top-36">
                  <div
