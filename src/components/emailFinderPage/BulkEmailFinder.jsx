...
const BulkEmailFinder = () => {
  ...
  return (
    ...
    >
      ...
      <div className="home-container pt-10 sm:pt-12 md:pt-14 lg:pt-16 xl:pt-20">
        ...
        <div className="w-full flex flex-col gap-10">
          ...
          <div>
            ...
            <div className="relative w-full max-w-full mx-auto -top-17 md:-top-25 lg:-top-30 xl:-top-40">
