...
const SalesProspecting = () => {
  ...
  return (
    <section className="relative w-full flex items-center justify-center overflow-hidden">
      <div className="home-container mx-auto px-0 sm:px-6 md:px-8 lg:px-12 xl:px-[100px] 2xl:px-[150px] pb-[60px]">
        <div className="relative home-container mx-auto rounded-[24px]">
          <div className="home-container mx-auto  flex flex-col gap-[50px] px-4 sm:px-6 md:px-8 lg:px-12 ">
            <div
              className="w-full home-container mx-auto h-[95px] flex items-center justify-center rounded-[16px] relative"
              style={{
                background:
            ...
            <div className="w-full home-container mx-auto flex flex-col lg:flex-row items-center lg:items-start gap-[50px]">
