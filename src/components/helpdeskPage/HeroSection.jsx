...
const HeroSection = () => {
  return (
    ...
    >
      {/* Main Container */}
      <div className="px-4 sm:px-6 md:px-8 lg:px-12 xl:px-[100px] 2xl:px-[150px] py-[80px] sm:py-[100px]">
        {/* Header Section - Second Image */}
        <div className="w-full max-w-full flex flex-col items-center gap-[21px] mb-[21px]">
          {/* Title Section - Third Image */}
          <div className="w-full max-w-[1050px] flex flex-col items-center gap-[21px]">
            {/* Main Title with Icons */}
            <h1 className="flex flex-wrap items-center justify-center max gap-2 sm:gap-3 text-center font-['Inter'] text-[clamp(36px,4vw,44px)] font-semibold leading-[100%] tracking-[-2.2px] text-[#132436] max-w-[66%] mx-auto">
              <span>Answers</span>
        ...
        <div className="relative w-full max-w-full lg:max-w-[1362px] mx-auto mt-[40px] sm:mt-[80px] md:mt-[100px] lg:mt-[150px]">
          ...
          <div className="relative z-10 w-full max-w-full lg:max-w-[1022px] mx-auto flex flex-col lg:flex-row gap-[30px] lg:gap-[21px] justify-center">
            ...
            >
              ...
              <div className="w-full max-w-[611px] rounded-[12px] bg-white pt-[30px] pr-5 sm:pr-[20px] pb-[30px] pl-5 sm:pl-[20px] flex flex-col items-center gap-[30px]">
                ...
                <div className="w-full max-w-[571px] flex flex-col items-center justify-between gap-4">
                  {/* Title */}
                  <h2 className="font-['Inter'] text-[clamp(24px,2.5vw,26px)] font-semibold leading-[50px] tracking-[-1.2px] text-center text-[#132436]">
                    Technical Support
                  </h2>

                  {/* Description */}
                  <p className="font-['Manrope'] text-[clamp(18px,2vw,20px)] font-medium leading-[40px] tracking-normal text-center text-[#585D71]">
                ...
                <div className="relative w-full max-w-[446px]">
                  ...
                  <div className="relative flex items-center justify-center h-[70px]">
                    <a
                      ...
                      className="font-['Manrope'] text-[clamp(18px,2vw,20px)] font-bold leading-[100%] tracking-normal text-center text-[#000000] hover:opacity-80 transition-opacity"
                    >
                      support@zupitu.com
                    </a>
                  </div>
                ...
                <div className="relative w-full max-w-[446px]">
                  ...
                  <div className="relative flex items-center justify-center h-[70px]">
                    <a
                      ...
                      className="font-['Manrope'] text-[clamp(18px,2vw,20px)] font-bold leading-[100%] tracking-normal text-center text-[#132436] hover:opacity-80 transition-opacity"
                    >
                      success@zupitu.com
                    </a>
                  </div>
